...
DAT_PATH = os.path.normpath(
    os.path.join(_THISDIR, "../../data/pupil/3_processed/4_downsampled")
)
SAVE_PATH = os.path.normpath(
    os.path.join(_THISDIR, "../../data/pupil/3_processed/5_timelocked")
)
...
def interpolate_blinks(sBlink_idx, eBlink_idx, pupilSize):
    ...
    if (eBlink_plus1 < len(pupilSize)) and (sBlink_minus1 >= 0):
        ...
        afterInterpolate = afterInterpolate[
            1:-1
        ]  # Remove the point before and after blink
